...
const Footer = () => {
    ...
    return (
        <footer className="w-full bg-[#0F172A] border-t border-white/10 text-white">
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">

                {/* Global CTA Buttons - Hide on Service Pages */}
                {!isServicePage && (
                    <div className="w-full pt-16 pb-8 border-b border-white/10">
                ...
                <div className="py-20 md:py-32">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
                        ...
                        <div className="space-y-8">
                            ...
                            <p className="text-sm md:text-body-custom font-body text-white/80 max-w-md leading-relaxed font-bold">
                        ...
                        <div className="space-y-12">
                            <div>
                                <h3 className="text-3xl md:text-4xl font-heading font-black uppercase tracking-wider text-white mb-8 italic">Contact</h3>
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4">
                                        <Mail className="text-white shrink-0" size={24} />
                                        <p className="text-base md:text-xl font-body font-bold text-white/80">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <p className="text-base md:text-xl font-body font-bold text-white/80 leading-snug">
                                            Saloni Plaza HP8G+23G, Shiv Marg, Hiran Magri, Sector 5, Gyan Nagar, Udaipur, Rajasthan, India 313002
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <h3 className="text-3xl md:text-4xl font-heading font-black uppercase tracking-wider text-white mb-8 italic">Follow</h3>
